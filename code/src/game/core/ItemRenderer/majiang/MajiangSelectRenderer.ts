 ...
 * @Last Modified time: 2019-05-16 16:29:29
 @Description:游戏玩法赋值
 */
...
module majiang {
	export class MajiangSelectRenderer extends game.BaseUI {
		...
		protected onTouchTap(e: egret.TouchEvent) {
			...
			EventManager.instance.dispatch(EventNotify.ENTER_GOLD_SCENE, { gameId: Global.gameProxy.getSceneNameByStr(this.gameType), sceneId: this.sceneId, diFen: this.data["bet_base"], diZhu: this.data["gold_min"] });
