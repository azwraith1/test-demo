...
class GameLayerManager extends eui.UILayer {
    ...
    public init(): void {
        ...
        // }
        // this.pingLabel = new eui.Label("");
        // this.pingLabel.size = 15;
        // this.pingLabel.bottom = 0;
        // this.pingLabel.right = 0;
        // this.loadLayer.addChild(this.pingLabel);
    }

    public showPingTime(){
        this.pingLabel.text = game.PomeloManager.instance.startPingTime + "ms";
    }
