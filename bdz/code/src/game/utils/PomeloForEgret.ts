 ...
 * @Last Modified time: 2018-12-07 13:43:03
...
module PomeloForEgret {
    export class Pomelo {
        ...
        private initWebSocket(host, port, cb: Function): void {
            ...
            let url;
            if(ServerConfig.PATH_CONFIG.socket_path_1){
                url = ServerConfig.PATH_CONFIG.socket_header + host + ":" + port + ServerConfig.PATH_CONFIG.socket_path_1;
            }else{
                 url = ServerConfig.PATH_CONFIG.socket_header + host + ":" + port;
            }
        ...
        private onClose(e: egret.Event): void {
            ...
            EventManager.instance.dispatch(Pomelo.EVENT_CLOSE, e);
